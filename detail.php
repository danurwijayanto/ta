<?php
	function scan_interface(){
		...
		$id_if = snmpwalk("182.255.0.34", "public", ".1.3.6.1.2.1.2.2.1.1");
		$nama_if = snmpwalk("182.255.0.34", "public", ".1.3.6.1.2.1.2.2.1.2");
		$status_if = snmpwalk("182.255.0.34", "public", ".1.3.6.1.2.1.2.2.1.7");
		...
		for ($i=0; $i<$panjang_if; $i++){
			...
			//Simpan ke database
			$query = "INSERT INTO data_interface (id_interface, interface_index, nama_interface, ip_address, status, id_perangkat)
	...
	function print_interface($id){
		$id=$_GET['id'];
		$syscontact = snmpget("172.20.5.3", "public", ".1.3.6.1.2.1.1.1.0");
		$uptime = snmpget("172.20.5.3", "public", ".1.3.6.1.2.1.1.3.0");
		$totalmem = snmpget("172.20.5.3", "public", ".1.3.6.1.2.1.25.2.3.1.5.65536");
		$usedmem = snmpget("172.20.5.3", "public", ".1.3.6.1.2.1.25.2.3.1.6.65536");
		$ipaddress = snmpwalk("172.20.5.3", "public", ".1.3.6.1.2.1.4.20.1.1");
		...
		for ($a=0; $a<$panjangipaddress; $a++){
			...
			$ifindex = snmpwalk("172.20.5.3", "public", ".1.3.6.1.2.1.4.20.1.2.$ipaddressnew");	
			$ifindexnew = eregi_replace("INTEGER: ","",implode($ifindex));	
				
			$namainterface =  snmpwalk("172.20.5.3", "public", ".1.3.6.1.2.1.2.2.1.2.$ifindexnew");
			$adminstatus =  snmpwalk("172.20.5.3", "public", ".1.3.6.1.2.1.2.2.1.7.$ifindexnew");
